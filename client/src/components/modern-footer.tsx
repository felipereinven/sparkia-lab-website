      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="py-16">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            >
              <div className="text-3xl font-bold gradient-text mb-6">Sparkia Lab</div>
              <p className="text-muted-foreground mb-8 max-w-md leading-relaxed">
                Agencia digital estratégica que ayuda a emprendedores y pequeñas empresas a construir una presencia digital auténtica, automatizada y coherente con IA.
              </p>
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <button 
                    ...
                    className="btn-primary px-6 py-3 rounded-full text-sm font-semibold mt-4"
                  >
                    Empezar Ahora
                  </button>
                </li>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center text-muted-foreground text-sm">
            <div className="mb-4 md:mb-0">
              <p>&copy; {currentYear} Sparkia Lab. Todos los derechos reservados.</p>
            </div>
